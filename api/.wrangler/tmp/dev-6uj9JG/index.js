...
// .wrangler/tmp/bundle-tZAw8P/checked-fetch.js
...
// .wrangler/tmp/bundle-tZAw8P/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-tZAw8P/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.post(
  ...
  async (c) => {
    ...
    const token = await sign2({ userId: res.id }, c.env.JWT_SECRET);
    c.status(200);
