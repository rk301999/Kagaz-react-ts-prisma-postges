...
// .wrangler/tmp/bundle-r38Cj5/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "D:\\100xDevs\\Medium\\hono-boilerplate\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\100xDevs\\Medium\\hono-boilerplate\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// node_modules/@rk301999/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@rk301999/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
    ...
    exports.createpostinput = zod_1.default.object({
      ...
      published: zod_1.default.boolean().optional().default(false)
    });
...
// .wrangler/tmp/bundle-r38Cj5/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-r38Cj5/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  try {
    ...
    const token = await sign2({ id: res.id }, c.env.JWT_SECRET);
    c.status(200);
...
postRouter.use("/*", async (c, next) => {
  ...
  const verifyJWT = await verify2(token, c.env.JWT_SECRET);
  if (!verifyJWT) {
    c.status(401);
    return c.json({ error: "unauthorized user" });
  }
...
postRouter.post("/", async (c) => {
  ...
  const body = await c.req.json();
  const { success } = import_medium_common2.createpostinput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json("input validation failed ");
  }
...
postRouter.put("/", async (c) => {
  ...
  const body = await c.req.json();
  const { success } = import_medium_common2.updatepostinput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json("input validation failed ");
  }
